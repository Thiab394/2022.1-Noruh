...
|**Impacto**| Uma comanda é aberta <br> O usuário abre uma comanda <br> O estabelecimento gerencia comandas. |
...
|**Impacto**| O usuário avalia um estabelecimento. <br> O estabelecimento possui uma nota de avaliações |
...
|**Impacto**| O usuário visualiza horários <br> O usuário cadastra horários de funcionamento. |
...
|**Impacto**| As informações pessoais do usuário são editadas. |

### Léxico 14

|**L14**| Formas de pagamento |
|---|---|
|**Classificação**| Objeto |
