...
| :------: | :------------------------------------------------:|:--------:|:--------:|:----------:|
| US01 | RF1 | Eu, como um usuário, gostaria de criar uma conta no Noruh para poder ter acesso às funcionalidades do aplicativo.| Must|- O formulário para criar conta deve ter as seguintes opções: <br>-Se preferir cadastrar com conta Facebook ou google<br>-Nome<br>-Data de nascimento(opcional)<br>-Gênero<br>-E-mail<br>-CPF(opcional)<br>-Telefone(opcional)<br>-Senha|
| US02 | RF2 | Eu, como um usuário, gostaria de realizar login na minha conta, para poder acessar e fazer pedidos.| Must|-Ter a opção de realizar login com a conta Google ou Facebook<br>-Ter a opção de fazer login com seu email pedindo:<br>-E-mail<br>-senha|
| US03 | RF3 | Eu, como um usuário, gostaria de fazer pedidos, para poder com meu celular, pedir a minha comida no restaurante. | Must|-Para se fazer o pedido precisa de:<br>-Abrir comanda<br>-Escolher o produto no cardápio<br>-Fazer o pedido|
...
| US05 | RF5 | Eu, como um usuário, gostaria de abrir a comanda por um QR code, para poder dessa forma mais prática escolher meu pedido.| Must|-Após ecolher o restaurante desejado, o usuário deve apertar os seguintes botões:<br>-Abrir comanda<br>-Ler QRcode|
| US06 | RF6 | Eu, como um usuário, gostaria de editar o meu perfil , para poder mudar informações da minha conta.| Must|-Estar na parte de perfil no canto superior esquerdo;<br>- Poder editar os seguintes dados:<br>- Nome<br>-Data de nascimento<br>-Gênero<br>-E-mail<br>-CPF<br>Telefone<br>-Trocar senha|
| US07 | RF7 | Eu, como um usuário, gostaria de pesquisar restaurantes no aplicativo, para poder escolher o restaurante de minha preferência.| Must|-Ter uma lupa no canto superior direito da pagina inicial;<br>-Poder pesquisar por categoria.<br>- Poder pesquisar por nome|
| US08 | RF8 | Eu, como um usuário, gostaria de ter acesso aos termos de uso, para poder analisar as informações que o aplicativo utiliza.| Must|-Ter acesso no momento em que cria a conta no aplicativo.<br>- Ter acesso também após ser feito o login no seu perfil|
| US09 | RF9 | Eu, como um usuário, gostaria de ver as localizações dos estabelecimentos, para poder chegar ao restaurante com o GPS.| Must|-Ter acesso ao clicar no restaurante selecionado.<br>- Ser pareado com o google Maps|
| US10 | RF10 | Eu, como um usuário, gostaria de cadastrar múltiplos endereços, para poder salvar no aplicativo caso eu precise.| Must|-Conseguir cadastrar na parte do seu perfil no canto superior esquerdo da pagina inicial clicando no seuinte botão:<br>- Endereços<br>- Simbolo "+"<br>- Pedir permissão para ter acesso à localização do celular<br>- Precisa pedir os seguintes campos:<br>-Identificação<br>-Cep<br>-Endereço<br>-Número<br>-Complemento<br>-Bairro<br>-Estado<br>-Cidade |
| US11 | RF11 | Eu, como um usuário, gostaria de fazer logout no meu perfil, para poder fazer login com outro perfil no meu celular.| Must|-O usuário deve conseguir desconectar da sua conta na parte do perfil no canto superior esquerdo da tela inicial.|
...
| US14 | RF14 | Eu, como um usuário, gostaria de cadastrar cartões de crédito/débito, para poder acessá-los de forma rápida e prática.| Should|-Poder cadastrar na parte do perfil no canto superior esquerdo da tela inicial clicando no seguinte botão;<br>- Formas de pagamento<br>-Além de adicionar o cartão de crédito deve se pedir um endereço de cobrança<br>-E também poder cadastrar ao precisar pagar a conta em algum estabelecimento.|
...
| US18 | RF18 | Eu, como um usuário, gostaria de acessar o histórico de contas, para poder verificar informações sobre contas anteriores.| Should|-Conseguir acessar o histórico de contas na parte superior esquerda do perfil no seguinte botão:<br>- "ultimas contas".|
| US19 | RF19 | Eu, como um usuário, gostaria de ver descrições sobre os bares/restaurantes, para poder verificar informações mais detalhadas sobre o estabelecimento.| Should|-Após clicar no restaurante selecionado, ele deve ter uma descrição detalhada sobre como é, o que oferece,..., para o cliente saber o que o espera.|
...
| US26 | RF26 | Eu, como um usuário, gostaria de ver bares/restaurantes com promoções, para poder economizar ao frequentar um estabelecimento.| Could|-Na página inicial, mostrar os restaurantes que estão com desconto em um botão "descontos".|
| US27 | RF27 | Eu, como um usuário, gostaria de entrar na fila de espera dos bares/restaurantes, para poder esperar minha vez de ser atendido.| Could|-Ter a opção de entrar na fila de espera, quando desejado|
...
|  3.0   | Atualizou os critérios de aceitação  |    João Henrique, Eurico    |    Lucas      | 08/09/22 | 11:00 às 12:00|
