...
Como podemos ver no checklist obtivemos as informações abaixo:
- 6 ERROS e 10 ACERTOS
- 62,5% de acertos na especificação suplementar após a inspeção
#### 5.2 Grafico de acompanhamento
- Uma forma melhor para ver as informações acima, podemos ver no gráfico abaixo:
...
## 8.Acompanhamento
### 8.1 Porcentagem de sucesso do checklist
Como podemos ver no checklist obtivemos as informações abaixo:
